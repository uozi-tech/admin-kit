...
<template>
  <AForm ref="formRef" :model="formData" label-width="auto" :labelAlign="labelAlign ?? 'left'" :layout="props.layout ?? 'vertical'">
    <AFormItem
    ...
    >
      <FormControllerRender :lang="lang" :column="c" :formData="formData" />
    </AFormItem>
  </AForm>
</template>