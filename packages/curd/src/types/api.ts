export interface CurdApi<T = any, P = any> {
  ...
  getItem: (id: string | number, config?: Record<string, any>) => Promise<T>
  ...
  deleteItem: (id: string | number, config?: Record<string, any>) => Promise<any>
  restoreItem: (id: string | number, config?: Record<string, any>) => Promise<any>
